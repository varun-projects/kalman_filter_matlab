...
var content = "Kalaman predicted speed " + list[id].kf_speed_total + '  '+ " Kalaman position covariance " + list[id].kf_covariance_lat + '  '+ " Kalaman latitude " + list[id].kf_latitude + '  '+ " Kalaman longitude " + list[id].kf_longitude
var infowindow = new google.maps.InfoWindow()
google.maps.event.addListener(marker,'click', (function(marker,content,infowindow){ 
        return function() {
           infowindow.setContent(content);
